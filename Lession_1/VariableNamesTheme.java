public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        int costCoffeToGo = 200;
        System.out.println("Стоимость кофе на вынос" + " = " + costCoffeToGo);

        // Дата начала
        String startDate = "15.11.2023";
        ...
        // Путь до файла
        String pathFile = "/home/ya/Java/StartJava/VariableNamesTheme.java";
        ...
        int discountAmount = (int) (fullPrice * 0.11);
        int salePrice = fullPrice - discountAmount;
